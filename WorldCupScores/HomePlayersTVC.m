...
@interface HomePlayersTVC ()

@end

@implementation HomePlayersTVC
...
{
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"homePlayer" forIndexPath:indexPath];
